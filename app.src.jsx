...
/* ============================================================
   ...
   ============================================================ */
const SKETCH_W = 1024, SKETCH_H = 576;       // 16:9
...
function SketchScreen({ title, onDone, onHome, onHelp }){
  ...
  function paintStroke(ctx, s){
    if(s.pts.length === 1){ dot(ctx, s.tool, s.pts[0]); return; }
    styleFor(ctx, s.tool);
    ctx.beginPath();
  ...
  function down(e){
    ...
    const p = ptAt(e);
    active.current = { tool: toolRef.current, pts: [p] };
    ...
    <div className="screen with-chrome">
      <div className="sketch-wrap">
        ...
        <div className="sketch-tools">
          ...
          <button className="tool-btn" disabled={!dirty} onClick={undo}>Undo</button>
        </div>
      </div>
      <div className="entry-actions">
